...
// j is bookmark for place in the overall recipe list from first API call of page load
// invokes removeRecipes
// reveals instructions to Click Again and applies class for slide animation
const renderRecipes = (recipeData) => {
  ...
  if (document.querySelector(".hide-it-info")) {
    ...
    document.querySelector(".info").classList.add('anim-info')
  }
  for (let i = 0; i < recipeData.length; i++) {
    ...
    trackNum.className = 'hide-it-num'
